...
INSERT INTO `category` VALUES (1,'TOTO'),(2,'TOTO'),(3,'ACTIOn');
...
CREATE TABLE `rate` (
  ...
  `movie_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_movie_rate_idx` (`movie_id`),
  CONSTRAINT `FK_movie_rate` FOREIGN KEY (`movie_id`) REFERENCES `category_movie` (`category_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-16 17:59:42
